...
$output .= '</div></div>'.$this->endBlockComment('separator')."\n";
 ...
 $output .= '<div class="sep_shape" style="background:'.$shapecolb.'">';
  ...
  $output .='<svg class="up-large-triangle" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="'.$shapecol.'" width="100%" height="91" viewBox="0 0 4.66666 0.333331" preserveAspectRatio="none"><path class="fil0" d="M-0 0.333331l4.66666 0 0 -3.93701e-006 -2.33333 0 -2.33333 0 0 3.93701e-006zm0 -0.333331l4.66666 0 0 0.166661 -4.66666 0 0 -0.166661zm4.66666 0.332618l0 -0.165953 -4.66666 0 0 0.165953 1.16162 -0.0826181 1.17171 -0.0833228 1.17171 0.0833228 1.16162 0.0826181z"></path></svg>';
