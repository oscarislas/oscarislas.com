...
<div class="col-md-6 top_bar_right"> 
 ...
 <?php  }
	...
	<?php global $post;$id = get_the_ID(); $stih = get_post_meta( $id, '_horseclub_head_s', true );?>
 <div id="up_topbar" class="topclass <?php if ($stih != '') {echo $stih;} else {echo 'enable_sticky';} ?>">
 <div class="container">
 <div class="row">
...
<div  class="topclass" >
 ...
 <?php wp_nav_menu( array('theme_location' => 'mobile_navigation','items_wrap' => '<ul id="%1$s" class="%2$s">%3$s</ul>', 'menu_class' => 'up-mobnav')); ?>
 </div> 
 </div> 
 </div> 
 <?php  endif; ?>
